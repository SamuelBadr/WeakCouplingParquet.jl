    ...
    cnorm * (
        (-2 ^ -1) * (
            (
                ...
                (
                    4 * mu * u + 2 * u * w - (2 * u * disp(k3)) - (2 * u * disp(-1k3 + q)) -
                    (2 * cnorm * u ^ 2 * fermidist(-1mu + disp(k3), beta)) +
                    2 * cnorm * u ^ 2 * fermidist(mu - disp(-1k3 + q), beta) +
                    2 *
                    cnorm *
                    mu *
                    ifelse(
                    ...
                    ifelse(
                        ...
                        (-1mu + vp - w + disp(k1) - disp(k3) + disp(-1k1 + k3 - kp + q)) ^
                        -1,
                    ) +
                    cnorm *
                    w *
        ...
        (
            ...
            (
                ...
                cnorm * ifelse(
                    ...
                    (-1mu + v - w - disp(k2) + disp(-1k + k1 + k2) + disp(-1k1 + q)) ^ -1,
                ) +
                cnorm * ifelse(
            ...
            (
                ...
                ifelse(
                    ...
                    (mu + vp - disp(k3) - disp(-1k1 + q) + disp(-1k1 + k3 - kp + q)) ^ -1,
                ) +
                cnorm *
                w *
                ifelse(
                ...
                ifelse(
                    ...
                    (mu - vp + w - disp(k3) + disp(-1k1 + k3 + kp) - disp(-1k1 + q)) ^ -1,
                ) +
                cnorm *
                w *
                ifelse(
