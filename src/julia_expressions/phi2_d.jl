function phi2_d(
    ...
    cnorm * (
        (
            ...
            (
                mu * u + u * vp + u * w + u * disp(k1) - (u * disp(k3)) -
                (u * disp(k1 - k3 + kp + q)) -
            ...
            (
                mu * u + u * v + u * w + u * disp(k1) - (u * disp(k2)) -
                (u * disp(k + k1 - k2 + q)) -
        ...
        (
            ...
            (
                ...
                (
                    ...
                    ifelse(
                        ...
                        (-1mu - vp - w - disp(k3) + disp(-1k1 + k3 + kp) + disp(k1 + q)) ^
                        -1,
                    ) - (
                        2 *
                        cnorm *
                ...
                (
                    mu * u + u * v - (u * disp(k2)) + u * disp(k1 + q) -
                    (u * disp(k + k1 - k2 + q)) -
                    (cnorm * u ^ 2 * fermidist(-1mu + disp(k2), beta)) +
                    cnorm * u ^ 2 * fermidist(mu - disp(k + k1 - k2 + q), beta) - (
                        2 *
            ...
            (
                ...
                (
                    -(u * v) + u * vp + u * disp(k2) - (u * disp(k3)) +
                    u * disp(k + k1 - k2 + q) - (u * disp(k1 - k3 + kp + q)) +
                    cnorm * u ^ 2 * fermidist(-1mu + disp(k2), beta) -
                    (cnorm * u ^ 2 * fermidist(mu - disp(k + k1 - k2 + q), beta)) +
                    2 *
                    cnorm *
